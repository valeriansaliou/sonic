...
use sonic::Executor;
use sonic::config::{NormalizationConfig, SearchConfig, StopwordsConfig, TokenizationConfig};
...
pub struct ChannelMessageModeSearch<'this> {
    ...
    pub search_config: &'this SearchConfig,
    pub normalization_config: &'this NormalizationConfig,
    pub tokenization_config: &'this TokenizationConfig,
    pub stopwords_config: &'this StopwordsConfig,
}
...
impl<'this> ChannelMessageMode for ChannelMessageModeIngest<'this> {
    fn handle(&self, message: &str) -> Result<Vec<ChannelCommandResponse>, ChannelCommandError> {
        gen_channel_message_mode_handle!(message, COMMANDS_MODE_INGEST, self, {
            ...
            "COUNTC" => ChannelCommandIngest::dispatch_countc,
            "COUNTB" => ChannelCommandIngest::dispatch_countb,
            "COUNTO" => ChannelCommandIngest::dispatch_counto,
