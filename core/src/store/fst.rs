...
pub struct StoreFSTPool {
    ...
    graph_pool: Arc<RwLock<HashMap<StoreFSTId, StoreFSTBox>>>,
...
impl crate::config::ConfigStoreFST {
    ...
    fn store_path(&self, id: StoreFSTId, mode: StoreFSTPathMode) -> PathBuf {
        let StoreFSTId {
            collection_hash,
            bucket_hash,
        } = id;
    ...
    fn proceed_erase_collection(&self, collection_name: StoreItemPart) -> Result<u32, ()> {
        ...
        if !bucket_atoms.is_empty() {
            ...
            for bucket_atom in bucket_atoms {
                ...
                let bucket_target = StoreFSTId::from_atom(collection_atom, bucket_atom);
...
impl StoreFSTId {
    pub fn from_atom(collection_hash: StoreFSTAtom, bucket_hash: StoreFSTAtom) -> StoreFSTId {
        StoreFSTId {
            collection_hash,
            bucket_hash,
        }
