...
```bash
docker pull valeriansaliou/sonic:v1.1.6
```
...
```bash
docker run -p 1491:1491 -v /path/to/your/sonic/config.cfg:/etc/sonic.cfg -v /path/to/your/sonic/store/:/var/lib/sonic/store/ valeriansaliou/sonic:v1.1.6
```
...
* **Python**:
  1. **[asonic](https://github.com/moshe/asonic)** by [@moshe](https://github.com/moshe)
* **Go**:
  1. **[go-sonic](https://github.com/expectedsh/go-sonic)** by [@alexisvisco](https://github.com/alexisvisco)
* **PHP**:
  1. **[php-sonic](https://github.com/seijikun/php-sonic)** by [@seijikun](https://github.com/seijikun)
  2. **[php-sonic](https://github.com/php-sonic/php-sonic)** by [@touhonoob](https://github.com/touhonoob)
